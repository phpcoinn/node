...
try
{
	...
	$pharFile = $outDir . DIRECTORY_SEPARATOR . 'miner.phar';
	...
	$defaultStub = $phar->createDefaultStub('miner.php');

	$content = file_get_contents($srcDir. "/utils/miner.php");

	$phar->addFromString('miner.php', $content);
...
//	$phar->compressFiles(Phar::GZ);
	...
	rename($pharFile, $outDir . DIRECTORY_SEPARATOR . 'phpcoin-miner');

	echo "phpcoin-miner successfully created" . PHP_EOL;
}
catch (Exception $e)
{
	echo $e->getMessage();
