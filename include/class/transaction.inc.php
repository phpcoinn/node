...
/*        if($x['version']>=50&&$x['version']<=55&&$height<=216000){
        ...
        // asset transfer
/*        if (FEATURE_ASSETS && $x['version']==TX_VERSION_ASSETS_SEND) {
...
/*        if (FEATURE_ASSETS && $x['version']==TX_VERSION_ASSETS_MARKET) {
...
/*        if (FEATURE_ASSETS && $x['version']==TX_VERSION_ASSETS_CANCEL_ORDER) {
        ...
        if (FEATURE_ASSETS && $x['version']==TX_VERSION_ASSETS_DIVIDENDS) {
            $balance=$acc->balance($src);
            if ($balance<$x['val']||$x['val']<0.00000001) {
                _log("Not enough php balance", 3);
                return false;
            }
        }*/

/*        if (FEATURE_ASSETS && $x['version']==TX_VERSION_ASSETS_INFLATE) {
            $plus=intval($x['message']);
            if ($x['message']!=$plus) {
                _log("Invalid asset value", 3);
                return false;
...
/*        } elseif ($x['version']==2&&$height>=MN_START_HEIGHT) {
