                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="auth-content my-auto">
                                    ...
                                    <div class="mt-5 text-center">
                                        <p class="text-muted mb-0">Don't have a wallet ?
                                            <a href="/apps/wallet2/create_wallet.php" class="text-primary fw-semibold"> Create one now </a> </p>
                                    </div>
                                    <div class="mt-1 text-center">
                                        <p class="text-muted mb-0">Have a backup ?
                                            <a href="/apps/wallet2/import_accounts.php" class="text-primary fw-semibold"> Import accounts </a> </p>
                                    </div>
                                    ...
                                    <div class="mt-1 text-center">
                                        ...
                                        <a href="/apps/wallet2/auth.php" class="btn btn-primary w-100 waves-effect waves-light">Authenticate</a>
