	...
	<table class="table table-sm table-striped">
		...
		<?php foreach ($transactions as $transaction) { ?>
			<tr class="<?php if (!empty($transaction['error'])) { ?>table-danger<?php } ?>">
				...
				<td style="word-break: break-all"><?php echo h($transaction['message']) ?></td>
				<td><?php echo h($transaction['peer']) ?></td>
				<td><?php echo h($transaction['error']) ?></td>
                <td>
                    <a class="btn btn-danger btn-xs" href="<?php echo APP_URL ?>/?view=mempool&action=delete_tx&id=<?php echo urlencode($transaction['id'])  ?>&<?php echo Security::csrfQuery() ?>"
...
<a href="<?php echo APP_URL ?>/?view=mempool&action=empty_mempool&<?php echo Security::csrfQuery() ?>" class="btn btn-danger"
